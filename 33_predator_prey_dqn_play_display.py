...
def main():
    ...
    # Agents generation
    agnt_0 = DQN_Agent(state_size, action_size)
    agnt_1 = DQN_Agent(state_size, action_size)
    agnt_2 = DQN_Agent(state_size, action_size)
    agnt_3 = DQN_Agent(state_size, action_size)
